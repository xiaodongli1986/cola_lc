...
//  printf("\n\n (write_snapshot) vfac, a = %f %f \n",vfac, snapshot->a); // xiaodong
//  int ipar;
//  for(ipar=0; ipar<10; ipar++)
// 	 printf(" (write_snapshot) p[%d].v = %.4f %.4f %.4f \n",ipar, p[ipar].v[0], p[ipar].v[1], p[ipar].v[2]); // xiaodong
